...
res.render('index', { title: 'curriculum App', user : req.user });
});
router.get('/register', function(req, res) {
res.render('register', { title: 'curriculum App Registration'});
});
...
res.render('login', { title: 'curriculum App Login', user : req.user });
});
